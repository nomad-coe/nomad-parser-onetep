...
def test_scf(parser):
    ...
    parser.parse('tests/data/fluor/12-difluoroethane.out', archive, None)
...
def test_tddft(parser):
    ...
    parser.parse('tests/data/ethene/ethene_tddft.out', archive, None)
...
def test_charges(parser):
    ...
    parser.parse('tests/data/test20/test20.out', archive, None)
